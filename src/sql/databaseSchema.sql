...
`locationVenueVillage` ENUM ('Location', 'Venue', 'Village', 'Not Required'),
`delegateImpact` ENUM('Low', 'Medium', 'High') NOT NULL,
`showOnCIS` BOOLEAN NOT NULL,
`ticketAllocatedTo` ENUM('Control Office', 'Control Office (Admin)',
'Day Stewards', 'Night Stewards', 'AV', 'Finance', 'Hospitality', 'Information',
